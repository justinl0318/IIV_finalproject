...
b.options.category&&!b.g){var f="ACCEPTED"===b.status;window.dataLayer.push(Q("update",b.options.analyticsStorage||f,f),ta(b.status,b.g,b.o,b.m))}var h=oa(b.options,b.g);f=pa().filter(function(g){return!h(g)});var e=b.options;f.push({category:e.category,date:new Date,eea:b.g,siteId:e.siteId,status:d});try{window.localStorage.setItem("glue.CookieNotificationBar",JSON.stringify(f))}catch(g){console.error(g)}};this.J=function(){ua(b)};this.u=function(){b.L.debounce()};this.options=Object.assign({},P.g,
c);na+=1;this.id="glue-cookie-notification-bar-"+na;window.glueCookieNotificationBarLoaded&&this.listen("loaded",window.glueCookieNotificationBarLoaded);this.h=document.querySelector("."+this.options.autoMarginClass);this.L=new M(this.J);this.config=va(this);this.rendered=this.config.then(this.G)}
function va(a){var c,b,d,f,h,e;return H(function(g){switch(g.g){case 1:var k=v(a.options.language.split(/[-_]/)),l=k.next().value;k=k.next().value;k=l+"-"+(k||l).toUpperCase();b=(c=J.includes(k)?k:J.includes(l)?l:"")?"?hl="+c:"";d="2A"===a.options.category?"/glue/cookienotificationbar/config/2a.json":"/glue/cookienotificationbar/config/2b.json";g.o=2;return E(g,fetch("https://www.gstatic.com"+d+b),4);case 4:return f=g.j,E(g,f.json(),5);case 5:return h=g.j,g.return(h);case 2:return g.o=0,l=g.i.H,g.i=
null,e=l,console.error(e),g.return({required:!1})}})}
function sa(a,c){var b,d,f,h,e,g,k,l,m,u;return H(function(n){if(1==n.g)return E(n,wa(),2);a.root||(a.root=document.body);b=Object.assign({},c.content,a.options.content);d=a.id+"-label";f=b.mainText.replace(/\[(.+)\]/,function(){return a.options.siteId});h=document.createElement("div");h.classList.add("glue-cookie-notification-bar");h.id=a.id;h.setAttribute("aria-hidden","true");h.setAttribute("aria-labelledby",d);h.setAttribute("inert","true");h.setAttribute("role","region");h.tabIndex=-1;a.options.language!==
...
P.prototype.destroy=function(){var a=this,c,b,d,f,h;return H(function(e){if(1==e.g)return E(e,a.rendered,2);c=e.j;(null==(b=c)?0:b.parentNode)&&c.parentNode.removeChild(c);d=v(a.i);for(f=d.next();!f.done;f=d.next())h=f.value,h.removeEventListener("click",a.C),h.setAttribute("aria-hidden","true"),h instanceof HTMLButtonElement||h.removeEventListener("keydown",a.D),ya(h.parentElement)&&h.parentElement.setAttribute("aria-hidden","true");a.h&&(a.h.style.marginBottom="0px",window.removeEventListener("resize",
a.u));e.g=0})};
...
r.Object.defineProperties(P,{g:{configurable:!0,enumerable:!0,get:function(){return{analyticsStorage:!1,category:"2A",language:document.documentElement.lang,siteId:location.host,autoMarginClass:"glue-footer"}}}});function wa(){return H(function(a){return"loading"!==document.readyState?a.return():a.return(new Promise(function(c){document.addEventListener("DOMContentLoaded",function(){c()})}))})}
function ya(a){return!!a&&(a.classList.contains("glue-footer__global-links-list-item")||a.classList.contains("h-c-footer__global-links-list-item"))}function oa(a,c){var b=a.category;var d=a.siteId;return function(f){return f.category===b&&f.siteId===d&&f.eea===c}}function qa(){return arguments}function Q(a,c,b){var d={};return qa("consent",a,(d.ad_storage=(void 0===b?0:b)?"granted":"denied",d.analytics_storage=(void 0===c?0:c)?"granted":"denied",d))}
function ta(a,c,b,d){var f={};return Object.assign({},(f.event="user_consent",f),ra(a,void 0===c?!1:c,void 0===b?!1:b,void 0===d?!1:d))}function ra(a,c,b,d){var f={};return f.cookieConsent="UNKNOWN"===a?"none":""+("ACCEPTED"===a),f.isEEA=""+(void 0===c?!1:c),f.adsStorage=""+(void 0===d?!1:d),f.analyticsStorage=""+(void 0===b?!1:b),f};function S(a){return T.dataset["glueCookieNotificationBar"+(a.charAt(0).toUpperCase()+a.slice(1))]}function U(){P.apply(this,arguments)}var V=P;U.prototype=da(V.prototype);U.prototype.constructor=U;if(A)A(U,V);else for(var W in V)if("prototype"!=W)if(Object.defineProperties){var Aa=Object.getOwnPropertyDescriptor(V,W);Aa&&Object.defineProperty(U,W,Aa)}else U[W]=V[W];U.category=K;I("module$exports$google3$marketing$glue$lib$cookienotificationbar$cdn.CdnCookieNotificationBar.category",U.category);
U.status=L;I("module$exports$google3$marketing$glue$lib$cookienotificationbar$cdn.CdnCookieNotificationBar.status",U.status);var X;var T=void 0,Y;if(void 0===T)if(document.currentScript)Y=document.currentScript;else{var Ba=document.getElementsByTagName("script");Y=Ba[Ba.length-1]}else Y=T;T=Y;
if("false"!==S("autoload")){var Ca=S("analyticsStorage"),Da=S("category"),Ea=S("content"),Fa=S("language"),Ga=S("siteId"),Ha=S("autoMarginClass"),Z={};Ca&&(Z.analyticsStorage="true"===Ca);Object.values(K).includes(Da)&&(Z.category=Da);Fa&&(Z.language=Fa);Ga&&(Z.siteId=Ga);Ha&&(Z.autoMarginClass=Ha);Ea&&(Z.content=JSON.parse(Ea));X=new U(document.body,Z)}else X=void 0;U.instance=X;window.glue=Object.assign({},window.glue,{CookieNotificationBar:U});}).call(this);
